#Figure Target 11 and 13 indicators  by country and region -
#Luisa Fontoura - Aug2021 - Last update: 30 Oct

#This data summary was created using the percentage of protection of each indicator on previous analysis
#Please see Target_indicators.R for individual estimates by indicator
...
##
gap_sum<-read.csv(here("_dataFigure","gap-analysis_summary.csv"))
#Target as factor----
...
rm(data)
data <- target11
#remove WIO (only estimates by country) #Somalia was removed due lack of PA data and 
#South Africa was removed because the majority of indicators here estimated largely derived from tropical ecosystems that are not characteristic from the ZAF geographic portion.  
