...
#Luisa Fontoura - Aug2021 - Last update: 30 Oct
...
mangrove2010MPA <- read.csv(here("_dataTarget5","Intersection_mangrove2010_MPAs_no_overlayPAs.csv"))
mangrove2016MPA <- read.csv(here("_dataTarget5","Intersection_mangrove2016_MPA_no_overlayPAs.csv"))
...
#on land 
mangrove2010PA <- read.csv(here("_dataTarget5", "Intersection_LandPA_mangrove2010.csv"))
mangrove2016PA <- read.csv(here("_dataTarget5", "Intersection_LandPA_mangrove2016.csv"))
...
mangrove2010EEZ <-  read.csv(here("_dataTarget5", "Mangrove2010_area_OUT_PAs.csv"))
mangrove2016EEZ <-  read.csv(here("_dataTarget5", "Mangrove2016_area_OUT_PAs.csv"))
...
####Total MANGROVE AREA
#independent of temporal protection status 
total_mangrove_area2010<-read.csv(here("_dataTarget5",'Mangrove_area2010_Intersection_Country_layer.csv'))
total_mangrove_area2016<-read.csv(here("_dataTarget5","mangrove_area2016_intersection_country_layer.csv"))
